...
public class IfrProdi extends javax.swing.JInternalFrame {
    ...
    private void aksiSimpan(){
        ...
        if(btnSimpan.getText().equals("Simpan")){
            ...
            sqlinsert = "update tbprodi set prodi='"+vprodi+"' " + " where kd_prodi='"+vkd_prodi+"' ";
        }
         try{
            _Cnn = null;
            _Cnn = getCnn.getConnection();
    ...
    private void initComponents() {
        ...
        cmbJurusan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Pilih--", "Teknik Informatika", "Teknik Kimia", "Teknik Mesin" }));
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Table Data Prodi : klik 2x untuk menghapus/mengubah data"));
